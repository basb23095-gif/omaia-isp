# colors.py - نظام الألوان المركزي لـ OMAIA ISP
# غير أي لون هون بيتغير بكل المشروع

class Colors:
    # الألوان الأساسية
    GOLD = "#D4AF37"      # الذهبي - للشعار والأزرار الرئيسية
    GOLD_HOVER = "#B8941F"
    
    # الثيم الغامق
    DARK_BG = "#0f172a"      # خلفية الصفحة
    DARK_CARD = "#1e293b"    # خلفية الكروت
    DARK_INPUT = "#334155"   # خلفية الحقول
    DARK_BORDER = "#475569"
    DARK_TEXT = "#ffffff"
    ...
    def get_theme(is_dark=True):
        if is_dark:
            return {
                ...
                "input": Colors.DARK_INPUT,
                "border": Colors.DARK_BORDER,
                "text": Colors.DARK_TEXT,
                "muted": Colors.DARK_TEXT_MUTED,
            }
        else:
            return {
                "bg": Colors.LIGHT_BG,
                "card": Colors.LIGHT_CARD,
                "input": Colors.LIGHT_INPUT,
                "border": Colors.LIGHT_BORDER,
                "text": Colors.LIGHT_TEXT,
                "muted": Colors.LIGHT_TEXT_MUTED,
            }

# للاستخدام السريع - مهم جدا لـ app.py
COLORS = {
    "gold": Colors.GOLD,
    ...
    "btn_red": Colors.RED,
    "btn_wa": Colors.GREEN_WA,
    "text_dark": Colors.DARK_TEXT,
    "text_light": Colors.LIGHT_TEXT,
    "text_muted_dark": Colors.DARK_TEXT_MUTED,
    "text_muted_light": Colors.LIGHT_TEXT_MUTED,
    "border_dark": Colors.DARK_BORDER,
    "border_light": Colors.LIGHT_BORDER,
    "input_dark": Colors.DARK_INPUT,
    "input_light": Colors.LIGHT_INPUT,
    "blue": Colors.BLUE,
    "red": Colors.RED,
    "green": Colors.GREEN,
    "white": Colors.WHITE,
    "black": Colors.BLACK,
    "ping_bg": Colors.PING_BG,
    "ping_text": Colors.PING_TEXT,
}
