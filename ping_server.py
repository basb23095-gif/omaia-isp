    ...
    if v=='home':
        ...
        <div style='max-width:700px;margin:0 auto;text-align:center'>
          ...
          <div style='margin-top:16px;display:flex;gap:8px;justify-content:center;flex-wrap:wrap'>
            ...
            <a href='/api/export/logs' class=btn-gold style='text-decoration:none'>📜 سجل Excel</a>
            <button onclick="window.print()" class=btn-gold>📄 PDF</button>
          </div>
          <a href='https://wa.me/905344851045' target=_blank style='position:fixed;left:20px;bottom:20px;background:#25D366;color:#fff;width:56px;height:56px;border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:28px;text-decoration:none;box-shadow:0 8px 24px #0006;z-index:999'>💬</a>
...
window.openEditUser=function(ph){{
  ...
  document.getElementById('editBody').innerHTML='<input id=edit_u_field value="'+c.dataset.phone+'" placeholder="phone / uesr" style="width:100%;padding:14px;border-radius:12px;margin-top:6px;background:#0f1424;border:1px solid #ffffff20;color:#fff"><input id=edit_u_pass type="password" placeholder="🔑 password (فاضي = بدون تغيير)" style="width:100%;padding:14px;border-radius:12px;margin-top:10px;background:#0f1424;border:1px solid #ffffff20;color:#fff"><button onclick="window.saveUser(\\'"+ph+"\\')" class=btn-gold style="width:100%;padding:14px;margin-top:12px">💾 حفظ</button>';
}}
...
<div id=notifBell onclick="toggleNotif()" style='position:relative;cursor:pointer;font-size:20px'>🔔<span id=notifCount style='display:none;position:absolute;top:-6px;right:-6px;background:#ef4444;color:#fff;font-size:10px;width:18px;height:18px;border-radius:50%;align-items:center;justify-content:center'>0</span></div>
