...
# psycopg2 يفهم postgresql:// و postgres:// - نخلي الاثنين شغالين
...
def get_conn():
    """يرجع connection جديد كل مرة - آمن للـ threads"""
    if USE_PG:
