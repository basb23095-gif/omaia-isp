...
<div class=card><h4>👤 يوزر / رقم بنفس الكرت</h4>
<form data-ajax method=post action=/add_user style='display:flex;flex-direction:column;gap:6px'>
<input name=username placeholder='اسم المستخدم (اليوزر)' required>
...
<button class=btn-gold>➕ إضافة يوزر</button>
</form>
</div>
