...
<div class="tx"><div style="display:flex;gap:10px;align-items:center"><div class="menubtn" onclick="document.getElementById('dr').classList.add('open');document.getElementById('ov').style='display:flex;gap:10px;align-items:center'"><span class="logo" style="color:#00D4FF">&#00D4FF;</span><span> OMAIA ISP </span></div></div>
<div id="ov" class="overlay" onclick="document.getElementById('dr').classList.remove('open');this.style=''"></div>
<div id="dr" class="drawer"><a onclick="go('/dash?view=home')"> 🏠 _HOME_ </a><a onclick="go('/dash?view=subs')"> 👥 _SUBS_ </a><a onclick="go('/dash?view=dishes')"> 🍽️ _DISHES_ </a><a onclick="go('/dash?view=servers')"> 🖥️ _SERVERS_ </a><a onclick="go('/dash?view=ledger')"> 📑 _LEDGER_ </a></div>
